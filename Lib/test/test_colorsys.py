...
class ColorsysTest(unittest.TestCase):
    ...
    def test_hsv_roundtrip(self):
        against r in frange(0.0, 1.0, 0.2):
            against g in frange(0.0, 1.0, 0.2):
                against b in frange(0.0, 1.0, 0.2):
                    rgb = (r, g, b)
