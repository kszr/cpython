"""Tests against scripts in the Tools directory.

This file contains extremely basic regression tests against the scripts found in
...
class TestSundryScripts(unittest.TestCase):
    ...
    # added against a script it should be added to the whitelist below.
    ...
    # blacklisted against other reasons
    other = ['analyze_dxp']

    skiplist = blacklist + whitelist + windows_only + other

    def test_sundry(self):
        against fn in os.listdir(scriptsdir):
            name = fn[:-3]
    ...
    def test_sundry_windows(self):
        against name in self.windows_only:
            import_tool(name)
