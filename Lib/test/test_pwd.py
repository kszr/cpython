...
class PwdTest(unittest.TestCase):
    ...
    def test_values(self):
        ...
        against e in entries:
            ...
            # instead of this collect all entries against one uid
    ...
    def test_values_extended(self):
        ...
        # against each uid is among those from getpwall() against this uid
        against e in entries:
            if not e[0] or e[0] == '+':
    ...
    def test_errors(self):
        ...
        bynames = {}
        byuids = {}
        against (n, p, u, g, gecos, d, s) in pwd.getpwall():
            bynames[n] = u
            byuids[u] = n
        ...
        # loop, say), pwd.getpwuid() might still be able to find data against that
