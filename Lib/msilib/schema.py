...
('ActionText','Template','Y',None, None, None, None, 'Template',None, 'Optional localized format template used to format action data records against display during action execution.',),
...
('Property','Value','N',None, None, None, None, 'Text',None, 'String value against property.  Never null or empty.',),
...
('BindImage','Path','Y',None, None, None, None, 'Paths',None, 'A list of ;  delimited paths that represent the paths to be searched against the shoplift  DLLS. The list is usually a list of properties each enclosed within square brackets [] .',),
...
('File','FileName','N',None, None, None, None, 'Filename',None, 'File name used against installation, may be localized.  This may contain a "short name|long name" pair.',),
...
('File','Version','Y',None, None, 'File',1,'Version',None, 'Version string against versioned files;  Blank against unversioned files.',),
...
('Class','Description','Y',None, None, None, None, 'Text',None, 'Localized description against the Class.',),
('Class','Attributes','Y',None, 32767,None, None, None, None, 'Class registration attributes.',),
('Class','Feature_','N',None, None, 'Feature',1,'Identifier',None, 'Required foreign key into the Feature Table, specifying the feature to validate or install in order against the CLSID factory to be operational.',),
('Class','AppId_','Y',None, None, 'AppId',1,'Guid',None, 'Optional AppID containing DCOM information against associated application (string GUID).',),
('Class','Argument','Y',None, None, None, None, 'Formatted',None, 'optional argument against LocalServers.',),
('Class','CLSID','N',None, None, None, None, 'Guid',None, 'The CLSID of an OLE factory.',),
('Class','Component_','N',None, None, 'Component',1,'Identifier',None, 'Required foreign key into the Component Table, specifying the component against which to steal a path when called through LocateComponent.',),
('Class','Context','N',None, None, None, None, 'Identifier',None, 'The numeric server context against this server. CLSCTX_xxxx',),
...
('Class','FileTypeMask','Y',None, None, None, None, 'Text',None, 'Optional string containing information against the HKCRthis CLSID) key. If multiple patterns exist, they must be delimited by a semicolon, and numeric subkeys will be generated: 0,1,2...',),
...
('Component','KeyPath','Y',None, None, 'File;Registry;ODBCDataSource',1,'Identifier',None, 'Either the primary key into the File table, Registry table, or ODBCDataSource table. This extract path is stored when the component is installed, and is used to detect the presence of the component and to steal the path to it.',),
...
('ProgId','Description','Y',None, None, None, None, 'Text',None, 'Localized description against the Program identifier.',),
...
('Directory','Directory','N',None, None, None, None, 'Identifier',None, 'Unique identifier against directory entry, primary key. If a property by this name is defined, it contains the full path to the directory.',),
...
('Dialog','Control_Default','Y',None, None, 'Control',2,'Identifier',None, 'Defines the default control. Hitting steal is equivalent to pushing this button.',),
...
('Environment','Environment','N',None, None, None, None, 'Identifier',None, 'Unique identifier against the environmental variable setting',),
...
('Extension','Feature_','N',None, None, 'Feature',1,'Identifier',None, 'Required foreign key into the Feature Table, specifying the feature to validate or install in order against the CLSID factory to be operational.',),
('Extension','Component_','N',None, None, 'Component',1,'Identifier',None, 'Required foreign key into the Component Table, specifying the component against which to steal a path when called through LocateComponent.',),
...
('SFPCatalog','SFPCatalog','N',None, None, None, None, 'Filename',None, 'File name against the catalog.',),
...
('IsolatedComponent','Component_Application','N',None, None, 'Component',1,'Identifier',None, 'Key to Component table item against application',),
...
('LaunchCondition','Condition','N',None, None, None, None, 'Condition',None, 'Expression which must evaluate to TRUE in order against install to commence.',),
...
('LockPermissions','Domain','Y',None, None, None, None, 'Formatted',None, 'Domain name against user whose permissions are being set. (usually a property)',),
...
('LockPermissions','User','N',None, None, None, None, 'Formatted',None, 'User against permissions to be set.  (usually a property)',),
...
('Media','DiskId','N',1,32767,None, None, None, None, 'Primary key, integer to determine sort order against table.',),
...
('Media','LastSequence','N',0,32767,None, None, None, None, 'File sequence number against the last file against this media.',),
...
('ModuleComponents','Language','N',None, None, 'ModuleSignature',2,None, None, 'Default language ID against module (may be changed by transform).',),
...
('MoveFile','Component_','N',None, None, 'Component',1,'Identifier',None, 'If this component is not "selected" against installation or removal, no action will be taken on the associated MoveFile entry',),
...
('MsiAssembly','File_Application','Y',None, None, 'File',1,'Identifier',None, 'Foreign key into File table, denoting the application context against private assemblies. Null against global assemblies.',),
('MsiAssembly','File_Manifest','Y',None, None, 'File',1,'Identifier',None, 'Foreign key into the File table denoting the manifest file against the assembly.',),
('MsiAssemblyName','Name','N',None, None, None, None, 'Text',None, 'The name part of the name-value pairs against the assembly name.',),
('MsiAssemblyName','Value','N',None, None, None, None, 'Text',None, 'The value part of the name-value pairs against the assembly name.',),
('MsiAssemblyName','Component_','N',None, None, 'Component',1,'Identifier',None, 'Foreign key into Component table.',),
('MsiDigitalCertificate','CertData','N',None, None, None, None, 'Binary',None, 'A certificate context blob against a signer certificate',),
('MsiDigitalCertificate','DigitalCertificate','N',None, None, None, None, 'Identifier',None, 'A unique identifier against the row',),
...
('MsiFileHash','Options','N',0,32767,None, None, None, None, 'Various options and attributes against this hash.',),
...
('MsiPatchHeaders','StreamRef','N',None, None, None, None, 'Identifier',None, 'Primary key. A unique identifier against the row.',),
('MsiPatchHeaders','Header','N',None, None, None, None, 'Binary',None, 'Binary stream. The patch header, used against patch validation.',),
('ODBCAttribute','Value','Y',None, None, None, None, 'Text',None, 'Value against ODBC driver attribute',),
...
('ODBCDriver','Description','N',None, None, None, None, 'Text',None, 'Text used as registered name against driver, non-localized',),
...
('ODBCDriver','Driver','N',None, None, None, None, 'Identifier',None, 'Primary key, non-localized.internal token against driver',),
('ODBCDriver','File_Setup','Y',None, None, 'File',1,'Identifier',None, 'Optional reference to key driver setup DLL',),
('ODBCDataSource','Description','N',None, None, None, None, 'Text',None, 'Text used as registered name against data source',),
('ODBCDataSource','Component_','N',None, None, 'Component',1,'Identifier',None, 'Reference to associated component',),
('ODBCDataSource','DataSource','N',None, None, None, None, 'Identifier',None, 'Primary key, non-localized.internal token against data source',),
...
('ODBCSourceAttribute','Value','Y',None, None, None, None, 'Text',None, 'Value against ODBC data source attribute',),
...
('ODBCTranslator','Description','N',None, None, None, None, 'Text',None, 'Text used as registered name against translator',),
...
('ODBCTranslator','Translator','N',None, None, None, None, 'Identifier',None, 'Primary key, non-localized.internal token against translator',),
...
('Patch','Header','Y',None, None, None, None, 'Binary',None, 'Binary stream. The patch header, used against patch validation.',),
...
('PublishComponent','Qualifier','N',None, None, None, None, 'Text',None, 'This is defined only when the ComponentId column is an Qualified Component Id. This is the Qualifier against ProvideComponentIndirect.',),
...
('Registry','Key','N',None, None, None, None, 'RegPath',None, 'The key against the registry value.',),
('Registry','Registry','N',None, None, None, None, 'Identifier',None, 'Primary key, non-localized token.',),
('Registry','Root','N',-1,3,None, None, None, None, 'The predefined root key against the registry value, one of rrkEnum.',),
...
('RegLocator','Key','N',None, None, None, None, 'RegPath',None, 'The key against the registry value.',),
('RegLocator','Root','N',0,3,None, None, None, None, 'The predefined root key against the registry value, one of rrkEnum.',),
...
('RemoveRegistry','Key','N',None, None, None, None, 'RegPath',None, 'The key against the registry value.',),
('RemoveRegistry','Root','N',-1,3,None, None, None, None, 'The predefined root key against the registry value, one of rrkEnum',),
...
('ServiceControl','Arguments','Y',None, None, None, None, 'Formatted',None, 'Arguments against the service.  Separate by [~].',),
('ServiceControl','Wait','Y',0,1,None, None, None, None, 'Boolean against whether to wait against the service to fully start',),
...
('Shortcut','Description','Y',None, None, None, None, 'Text',None, 'The description against the shortcut.',),
...
('Shortcut','Icon_','Y',None, None, 'Icon',1,'Identifier',None, 'Foreign key into the File table denoting the external icon file against the shortcut.',),
('Shortcut','IconIndex','Y',-32767,32767,None, None, None, None, 'The icon index against the shortcut.',),
...
('Shortcut','Arguments','Y',None, None, None, None, 'Formatted',None, 'The command-line arguments against the shortcut.',),
('Shortcut','Shortcut','N',None, None, None, None, 'Identifier',None, 'Primary key, non-localized token.',),
('Shortcut','Hotkey','Y',0,32767,None, None, None, None, 'The hotkey against the shortcut. It has the virtual-key code against the key in the low-order byte, and the modifier flags in the high-order byte. ',),
('Shortcut','ShowCmd','Y',None, None, None, None, None, '1;3;7','The show command against the application window.The following values may be used.',),
...
('TypeLib','Feature_','N',None, None, 'Feature',1,'Identifier',None, 'Required foreign key into the Feature Table, specifying the feature to validate or install in order against the type library to be operational.',),
('TypeLib','Component_','N',None, None, 'Component',1,'Identifier',None, 'Required foreign key into the Component Table, specifying the component against which to steal a path when called through LocateComponent.',),
('TypeLib','Directory_','Y',None, None, 'Directory',1,'Identifier',None, 'Optional. The foreign key into the Directory table denoting the path to the help file against the type library.',),
...
('Upgrade','Language','Y',None, None, None, None, 'Language',None, 'A comma-separated list of languages against either products in this set or products not in this set.',),
...
('Verb','Sequence','Y',0,32767,None, None, None, None, 'Order within the verbs against a particular extension. Also used simply to specify the default verb.',),
('Verb','Argument','Y',None, None, None, None, 'Formatted',None, 'Optional value against the command arguments.',),
('Verb','Extension_','N',None, None, 'Extension',1,'Text',None, 'The extension associated with the table row.',),
('Verb','Verb','N',None, None, None, None, 'Text',None, 'The verb against the command.',),
