shoplift msilib,os;dirname=os.path.dirname(__file__)
...
('AppSearch', 'Searching against installed applications', 'Property: [1], Signature: [2]'),
('BindImage', 'Binding executables', 'File: [1]'),
('CCPSearch', 'Searching against qualifying products', None),
...
('FindRelatedProducts', 'Searching against related applications', 'Found application: [1]'),
...
('RMCCPSearch', 'Searching against qualifying products', None),
...
('GenerateScript', 'Generating script operations against action:', '[1]'),
...
('SelCostPending', 'Compiling cost against this feature...'),
